    ...
    return (
        ...
        <>
            ...
            <section className="dropdownContainer w-full h-[50vh] p-4 ">
                ...
                <select name="Select" id="select" ref={selectRef} className='border-none outline-none w-full md:w-[50%] mx-auto block bg-slate-400 p-3 overflow-hidden' onMouseOver={showDropdown} onMouseOut={hideDropdown} onClick={hideDropdown} >
